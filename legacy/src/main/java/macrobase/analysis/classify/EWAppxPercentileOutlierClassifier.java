...
public class EWAppxPercentileOutlierClassifier extends OutlierClassifier {
    ...
    public EWAppxPercentileOutlierClassifier(MacroBaseConf conf) {
        this(conf, conf.getInt(MacroBaseConf.SCORE_RESERVOIR_SIZE, MacroBaseDefaults.SCORE_RESERVOIR_SIZE), conf.getInt(MacroBaseConf.WARMUP_COUNT, MacroBaseDefaults.WARMUP_COUNT), conf.getDecayType(), conf.getDouble(MacroBaseConf.SUMMARY_UPDATE_PERIOD, MacroBaseDefaults.SUMMARY_UPDATE_PERIOD), conf.getDecayType(), conf.getDouble(MacroBaseConf.SUMMARY_UPDATE_PERIOD, MacroBaseDefaults.SUMMARY_UPDATE_PERIOD), conf.getDouble(MacroBaseConf.DECAY_RATE, MacroBaseDefaults.DECAY_RATE), conf.getDouble(MacroBaseConf.TARGET_PERCENTILE, MacroBaseDefaults.TARGET_PERCENTILE));
    }
    ...
    public EWAppxPercentileOutlierClassifier(MacroBaseConf conf, int sampleSize, int warmupCount, MacroBaseConf.PeriodType updatePeriodType, double updatePeriod, MacroBaseConf.PeriodType decayPeriodType, double decayPeriod, double decayRate, double percentile) {
        reservoir = new FlexibleDampedReservoir<>(sampleSize, decayRate, conf.getRandom());
        this.percentileUpdater = new Periodic(updatePeriodType, updatePeriod, () -> updateThreshold(percentile));
        this.reservoirDecayer = new Periodic(decayPeriodType, decayPeriod, reservoir::advancePeriod);
